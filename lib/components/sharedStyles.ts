...
export const voteButtonClasses =
  `${buttonClasses} mr-4 w-full text-center inline-block pt-6 pb-6 text-lg font-semibold`;
export const normalTextClasses = "text-gray-700 text-lg mb-4";
export const subHeadingClasses = "text-xl font-bold mb-8 text-gray-800";
...
export const normalInputClasses =
